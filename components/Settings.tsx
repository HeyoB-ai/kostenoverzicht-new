...
function doPost(e) {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h3 className="text-lg font-medium text-slate-800">Google Apps Script URL</h3>
        ...
        <div className="flex gap-2">
          <input
            ...
            className="flex-grow w-full px-3 py-2 border border-slate-300 rounded-md shadow-sm focus:ring-blue-500 focus:border-blue-500"
      ...
      <div className="bg-slate-50 rounded-lg border border-slate-200">
        ...
        >
          <span>Hoe stel ik dit in? (Klik voor instructies)</span>
